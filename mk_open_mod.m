...
nx=420; ny=384; nz=50; nt=12;
DXG=readbin('/scratch/general/am8e13/arctic420x384/run_template/DXG.bin',[nx ny]); 
DYG=readbin('/scratch/general/am8e13/arctic420x384/run_template/DYG.bin',[nx ny]);
...
%DXG = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'dxG' ), [ 0 0 ], [ nx ny ] );
%DYG = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'dyG' ), [ 0 0 ], [ nx ny ] );
HFACS = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacS' ), [ 0 0 0 ], [ nx ny nz ] );
HFACW = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacW' ), [ 0 0 0 ], [ nx ny nz ] );
tmp = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacC' ), [ 0 0 0 ], [ nx ny nz ] );
...
DXG = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'dxG' ), [ 0 0 ], [ nx/2 ny/2 ] );
DYG = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'dyG' ), [ 0 0 ], [ nx/2 ny/2 ] );
HFACS = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacS' ), [ 0 0 0 ], [ nx/2 ny/2 nz ] );
HFACW = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacW' ), [ 0 0 0 ], [ nx/2 ny/2 nz ] );
tmp = netcdf.getVar( ncid, netcdf.inqVarID( ncid, 'HFacC' ), [ 0 0 0 ], [ nx/2 ny/2 nz ] );
...
cd /scratch/general/am8e13/matlab_obcs/
pin='+OB1992_2010_average/';
pout='+OB1992_2010_c81_36km/';
...
eval(['cd /scratch/general/am8e13/matlab_obcs/' pout]); nx=210; ny=192;
